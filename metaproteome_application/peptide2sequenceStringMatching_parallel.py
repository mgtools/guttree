...
if len(sys.argv) != 5:
    ...
    os.system("cat "+out_dir+"* > peptide2allProteinMatches.txt")


    with open('peptide2allProteinMatches.txt', 'r') as in_f:
        fline = "peptide_ID\tpeptide\tprotein_match_ID\n"
        oline = in_f.readlines()
        oline.insert(0, fline)

    with open('peptide2allProteinMatches.txt', 'w') as out_f:
