...
then sum all the lengths of these contigs together and treat them as one genome.
...
third one is the directory to the folder containing all the contigs.
...
def read_sam():
    ...
    with open(sys.argv[1], 'r') as in_f:
        for i, row in enumerate(in_f):
            if i%10000.0 == 0:
                print ('processed '+str(i)+' lines of sam file\n')
