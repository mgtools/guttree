...
python3 make_iTOLcolorStylesFile.py $data_dir'phylum_LevelAllBin2TaxaMap_dic.json' $data_dir$taxonomy_level'_allTaxa2colorMap_dic.json' $taxonomy_level $out_dir
